...
const input = `eyr:2029 pid:157374862
...
const testInput3 = `pid:087499704 hgt:74in ecl:grn iyr:2012 eyr:2030 byr:1980
hcl:#623a2f
...
export const testData3 = (parseInput(
  testInput3,
  '\n\n',
) as string[]).map((e: string) => e.replace(/[\n]/g, ' '));

export const testData2 = (parseInput(
  testInput2,
  '\n\n',
) as string[]).map((e: string) => e.replace(/[\n]/g, ' '));

export const testData = (parseInput(
  testInput,
  '\n\n',
) as string[]).map((e: string) => e.replace(/[\n]/g, ' '));

export const data = (parseInput(input, '\n\n') as string[]).map((e: string) =>
  e.replace(/[\n]/g, ' '),
);
